        ...
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
            ...
            <View style={{ paddingHorizontal: 16 }}>
                ...
                <View style={styles.productContainer}>
                    <View style={{ width: "80%", }}>
                        <Text style={styles.productTitle}>{orderDetails?.name}</Text>
                ...
                <View style={styles.shippingContainer}>
                    ...
                    <View style={styles.shippingTextContainer}>
                        ...
                        <Text style={styles.shippingText}>+157 214 2541</Text>
                    </View>
                </View> */}
        ...
        <View style={[styles.priceRow,{borderBottomColor:"#E6E6E6", borderBottomWidth:1, paddingBottom:10}]}>
          ...
          <Text style={styles.priceValue}>$15.00</Text>
                    ...
                    <View style={[styles.priceRow, { borderBottomColor: "#E6E6E6", borderBottomWidth: 1, paddingBottom: 10 }]}>
                        ...
                        <Text style={styles.priceValue}>{orderDetails?.price}</Text>
                    </View>
